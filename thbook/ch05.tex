...
* |\copyrights| = is set according to copyright options for surveys and other
  objects
* |\cavename| = name of the exported map
...
* |\formattedlegend| = combines all four above commands to get
  ...
  adjust the count register |\legendcolumns| to get them more ore less)
...
The |\legendbox| macro has two parameters: specification of the position on the 
page (N, E, S, W, NE, SE, SW or NW) and the content to be displayed.
...
|\def\maplayout{\legendbox{NW}{\the\legendcontent}}|
