...
Ubuntu 18.04 or 20.04 example command for installing dependencies to compile Therion:
...
*  scraps count = approx. 1000--10\,000, depending on frequency of cross-sections
