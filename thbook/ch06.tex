...
\list
* unpack the source distribution |therion-0.5.*.tar.gz|
* |cd therion|
...
* {\bf 2007}\Nobreak
  ...
  Feb: Therion 0.5 --- geodetic coordinates systems \& geomag declination. 
  Support for bitmap sketches morphing.
\endlist
