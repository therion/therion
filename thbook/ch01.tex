...
(\www{|http://therion.speleo.sk|}{http://therion.speleo.sk}).
...
Therion on the data) and 3D model viewer.
...
* Tcl/Tk  with {\it BWidget}, {\it Tom} and optionally {\it tkImg} extension.
  It is only required for XTherion.
\endlist
...
Therion also exports 3D model (full or centreline) in various formats. The 
model in the |therion| format may be loaded and displayed in the XTherion's 
model viewer.
