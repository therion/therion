% The Therion Book
% Copyright (C) 2003 Martin Budaj, Stacho Mudrak
...
{\catcode`\*=13\catcode`\=13
 \gdef\itemize{%
   \par\leftskip1em%\parskip0pt
   \catcode`\*13\def*{\par\leavevmode\llap{$\bullet$ }\ignorespaces}
...
\def\arguments{\penalty-20\par{\it Arguments:}\bgroup\nobreak\itemize}
\def\endarguments{\par\egroup}

\def\options{\penalty-20\par{\it Options:}\bgroup\nobreak\itemize}
\def\endoptions{\par\egroup}

\def\comopt{\penalty-20\par{\it Command-like options:}\bgroup\nobreak\itemize}
\def\endcomopt{\par\egroup}

\def\example{\penalty-20\par{\it Example:} }
\def\endexample{}
