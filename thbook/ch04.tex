...
create table SHOT_ATTRIBUTE (SHOT_ID integer,
...
\NEW{6.4.1}User defined shot attributes set with the |shotattr| command are
exported to the |SHOT_ATTRIBUTE| table, one row per attribute, so a shot may
