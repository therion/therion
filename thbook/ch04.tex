...
values |NULL| is used. |FLAG| in |SHOT_FLAG| table is |dpl|, |srf|, |apx|, |spl|
or |art| for duplicated, surface, approximate, splay or artificial shots; in |STATION_FLAG| table |ent|, |con|, |fix|,
