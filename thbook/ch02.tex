...
\comopt
  ...
  * |vtreshold <number> <units>| = treshold for interpreting LRUD readings
  ...
  * |extend <spec> [<station> [<station>]]| =
    ...
    |break| = break series at given station (shot)
