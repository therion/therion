...
\comopt
  ...
  * |team <person> [<roles>]| = a survey team member. The first argument
    ...
    \vtop{\hsize.19\hsize #} &
    \vtop{\hsize.19\hsize #} &
    \vtop{\hsize.60\hsize #{\vrule width0pt depth.9em}} \cr
    {\it role}  & {\it alias}  & {\it intended meaning} \cr
    \noalign{\kern-.4em\hrule\kern.5em}
      ...
      position    & gps          & Recorded absolute positions of stations (e.g.\ fixed
    ...
    \NEW{6.3.5}|gps| was added as an alias for |position| in Therion 6.3.5.
