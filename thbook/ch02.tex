  ...
  * |<type>| determines the type of an object. The following
   ...
   (which is 0 by default).
    ...
    {\it symbolic passage fills:}\[Unlike other point symbols, these are
      ...
      put together}.]
    |bedrock|, |sand|, |raft|, |clay|, |pebbles|, |mud|, |mudcrack|,
    ...
    |flute|, |raft-cone|, \NEW{5.4}|clay-tree|, |curtains|, |disc-pillar|, |discs-pillars|, |disc-stalactite|,
    |discs-stalactites|, |disc-stalagmite|, |discs-stalagmites|, |helictites|, |pendant|, |pillar-with-curtains|,
    |pillars-with-curtains|, |stalactite-stalagmite|, |stalactites-stalagmites|, |volcano|;
    ...
    {\it others:} |dig|, |archeo-excavation|, |archeo-material|, |paleo-material|, |vegetable-debris|, 
    |root|, |water-flow|, 
    ...
    |u|\[For user defined point symbols.], |audio|, |altar|, |bat|, |bone|, |danger|, |electric-light|,
    |ex-voto|, |human-bone|, |minus|, |photo|, |plus|, |plus-minus|,
    |seed-germination|, |tree-trunk|, |water-drip|.
