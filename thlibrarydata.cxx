...
void thlibrary_init_layouts()
{
	...
	playout->get_last_line()->sclr = thlayout_color(0.180000,0.190000,0.570000);
	playout->set(thcmd_option_desc(TT_LAYOUT_SYMBOL_DEFAULTS,0),NULL,TT_UTF_8,0);
	playout->get_last_line()->code = TT_LAYOUT_CODE_SYMBOL_COLOR;
	playout->get_last_line()->smid = SYMX_SPELEOTHEMS;
	playout->get_last_line()->sclr = thlayout_color(0.870000,0.390000,0.230000);
	playout->set(thcmd_option_desc(TT_LAYOUT_SYMBOL_DEFAULTS,0),NULL,TT_UTF_8,0);
	playout->get_last_line()->code = TT_LAYOUT_CODE_SYMBOL_COLOR;
	playout->get_last_line()->smid = SYMX_SEDIMENTS;
	playout->get_last_line()->sclr = thlayout_color(0.500000,0.420000,0.390000);
	playout->set(thcmd_option_desc(TT_LAYOUT_SYMBOL_DEFAULTS,0),NULL,TT_UTF_8,0);
	playout->get_last_line()->code = TT_LAYOUT_CODE_SYMBOL_COLOR;
	playout->get_last_line()->smid = SYMX_CENTERLINE;
	playout->get_last_line()->sclr = thlayout_color(0.950000,0.000000,0.000000);
	playout->set(thcmd_option_desc(TT_LAYOUT_SYMBOL_DEFAULTS,0),NULL,TT_UTF_8,0);
	playout->get_last_line()->code = TT_LAYOUT_CODE_SYMBOL_COLOR;
	playout->get_last_line()->smid = SYMX_ICE;
	playout->get_last_line()->sclr = thlayout_color(0.000000,0.680000,0.940000);
