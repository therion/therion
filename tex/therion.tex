...
\def\colorlegendbox#1{%
  ...
  \immediate\pdfxform resources{/ExtGState \the\resid\space 0 R}\xxx
}
...
\def\black{\ifx\OutputColormodel\modelcmyk\cmykcolor[0 0 0 100]\else
           \ifx\OutputColormodel\modelrgb\rgbcolor[0 0 0]\else
           \graycolor[0]\fi\fi}
...
\def\checkstartslash #1#2\endparam{\ifx#1/\abspathtrue\fi}

\def\loadpicture#1{%
  \abspathfalse
  \checkcolon #1:\endparam
  \checkstartslash #1\endparam
  \pdfximage{\ifabspath\else\the\includeprefix/\fi#1}\pdfrefximage\pdflastximage
}
