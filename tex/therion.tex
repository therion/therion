...
%% macros from the texbook
\newcount\k  % registers used by the \rigidbalance routine
\def\rigidbalance#1#2{\setbox0=\box#1 \k=#2
  \line{\splittopskip=\legendsymbolht \vbadness=10000 \hfilneg
...
\def\splitoff{\dimen0=\ht0
  |^|\divide||\dimen0 by\k \advance\dimen0 by\legendsymbolht
  \vsplit0 to \dimen0 }

%% end of texbook macros
