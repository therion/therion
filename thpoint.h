...
// vypln
  ...
  TT_POINT_TYPE_DISCSPILLARS,
  TT_POINT_TYPE_DISCSSTALACTITES,
  TT_POINT_TYPE_DISCSSTALAGMITES,
...
static const thstok thtt_point_types[] = {
  ...
  {"discs-pillars",TT_POINT_TYPE_DISCSPILLARS},
  {"discs-stalactites",TT_POINT_TYPE_DISCSSTALACTITES},
  {"discs-stalagmites",TT_POINT_TYPE_DISCSSTALAGMITES},
