...
"\n"
"def l_floormeander_SM (expr P) =\n"
"  l_floorstep_UIS (P);\n"
"  l_floorstep_UIS (reverse P);\n"
"enddef;\n"
"\n"
...
"enddef;\n"
"\n"
"def l_ceilingmeander_SM (expr P) =\n"
"  l_ceilingstep_SKBB (P);\n"
...
"        qq := punked (((-.5u,-.5u)--(.5u,-.5u)--(.5u,.5u)--(-.5u,.5u)--cycle) \n"
"\t     randomized (u/2))\n"
"             rotated uniformdeviate(360) \n"
"             shifted ((i,j) randomized 1.6u);\n"
"\tif xpart (p intersectiontimes qq) < 0:\n"
"\t  thclean qq;\n"
"\t  thdraw qq;\n"
"\tfi;\n"
...
"let l_ceilingmeander = l_ceilingmeander_SM;\n"
"let l_floormeander = l_floormeander_SM;\n"
