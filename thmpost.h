...
"  to \"mptexpre.tex\";\n"
"  write \"\\def\\thtinysize{\\size[\" & decimal max(t*BaseScale/Scale,0) & \"]}\" & \n"
"        \"\\def\\thsmallsize{\\size[\" & decimal max(s*BaseScale/Scale,0) & \"]}\" & \n"
"        \"\\def\\thnormalsize{\\size[\" & decimal max(m*BaseScale/Scale,0) & \"]}\" & \n"
"        \"\\def\\thlargesize{\\size[\" & decimal max(l*BaseScale/Scale,0) & \"]}\" & \n"
"        \"\\def\\thhugesize{\\size[\" & decimal max(h*BaseScale/Scale,0) & \"]}\" \n"
"  to \"mptexpre.tex\";\n"
...
"    w := w * BaseScale/Scale;\n"
"\n"
"    defaultscale := 0.8 * BaseScale/Scale;\n"
"\n"
...
"%  string s;\n"
"%  s := \"ID_\" & str type & \"_\" & str name & \"_\" & str set & \" = 1\";\n"
"  s := \"ID_\" & name & \" = 1\";\n"
"  scantokens s;\n"
"enddef;\n"
"\n"
...
"\n"
"def p_gypsum_CCNP (expr pos,theta,sc,al)=\n"
"    U:=(.25u,.25u);\n"
"    T:=identity aligned al rotated theta scaled sc shifted pos;\n"
"    pickup PenC;\n"
"    thdraw (-.25u,0)--(.25u,0);\n"
...
"\n"
"def p_aragonite_CCNP (expr pos,theta,sc,al)=\n"
"    U:=(.3u,.4u);\n"
"    T:=identity aligned al rotated theta scaled sc shifted pos;\n"
"    pickup PenC;\n"
"    thdraw (0,-.4u)--(0,.3u);\n"
...
"\n"
"def p_cavepearl_JSSJ (expr pos,theta,sc,al)=\n"
"    U:=(.25u,.25u);\n"
"    T:=identity aligned al rotated theta scaled sc shifted pos;\n"
"    pickup PenC;\n"
...
"% @ENDSYMBOL\n"
"\n"
"def p_gypsumflower_CCNP (expr pos,theta,sc,al)=\n"
"    U:=(.4u,.3u);\n"
"    T:=identity aligned al rotated theta scaled sc shifted pos;\n"
"    pickup PenC;\n"
...
"\n"
"def p_raft_CCNP (expr pos,theta,sc,al)=\n"
"    U:=(.5u,.2u);\n"
"    T:=identity aligned al rotated theta scaled sc shifted pos;\n"
"    pickup PenC;\n"
...
"\n"
"def p_raftcone_CCNP (expr pos,theta,sc,al)=\n"
"    U:=(.3u,.4u);\n"
"    T:=identity aligned al rotated theta scaled sc shifted pos;\n"
"    pickup PenC;\n"
...
"\n"
"def p_lowend_CCNP (expr pos,theta,sc,al)=\n"
"    U:=(.4u,0);\n"
"    T:=identity aligned al rotated theta scaled sc shifted pos;\n"
"    pickup PenC;\n"
"    thdraw (-.4u,0)--(.4u,0);\n"
...
"\n"
"def p_flowstonechoke_CCNP (expr pos,theta,sc,al)=\n"
"    U:=(.4u,.3u);\n"
"    T:=identity aligned al rotated theta scaled sc shifted pos;\n"
"    pickup PenC;\n"
...
"\n"
"def p_breakdownchoke_CCNP (expr pos,theta,sc,al)=\n"
"    U:=(.5u,.2u);\n"
"    T:=identity aligned al rotated theta scaled sc shifted pos;\n"
"    pickup PenC;\n"
...
"    thfill p withpattern a_water_UIS;\n"
"    thdraw p;\n"
"enddef;\n"
"\n"
"% @SYMBOL\n"
...
"enddef;\n"
"\n"
"def p_sectionarrow_SKBB (expr pos,theta)=\n"
...
"\n"
"def p_station_NoMorph (expr pos)=\n"
"    T:=identity shifted pos;\n"
...
"% alignment!\n"
"\n"
"def p_rope_SKBB (expr pos,r,s,al) = thp_equipment_SKBB(pos,1) enddef;          \n"
"def p_fixedladder_SKBB (expr pos,r,s,al) = thp_equipment_SKBB(pos,2) enddef;   \n"
"def p_ropeladder_SKBB (expr pos,r,s,al) = thp_equipment_SKBB(pos,3) enddef;    \n"
"def p_steps_SKBB (expr pos,r,s,al) = thp_equipment_SKBB(pos,4) enddef;         \n"
"def p_bridge_SKBB (expr pos,r,s,al) = thp_equipment_SKBB(pos,5) enddef;        \n"
"def p_traverse_SKBB (expr pos,r,s,al) = thp_equipment_SKBB(pos,6) enddef;\n"
"def p_anchor_SKBB (expr pos,r,s,al) = thp_equipment_SKBB(pos,7) enddef;\n"
"def p_camp_SKBB (expr pos,r,s,al) = thp_equipment_SKBB(pos,8) enddef;\n"
"def p_noequipment_SKBB (expr pos,r,s,al) = thp_equipment_SKBB(pos,9) enddef;\n"
"\n"
"\n"
"def thp_equipment_SKBB(expr pos,type) =\n"
"  begingroup\n"
...
"  \telseif type=7: \"C\"    % camp\n"
"  \telseif type=9: \"!\"    % not equipped\n"
"  \tfi\n"
"  elseif lang=\"sk\":\n"
"    if type=1: \"L\"\n"
"  \telseif type=2: \"R\"\n"
...
"let l_section_SKBB = l_border_visible_SKBB;\n"
"\n\n\n%%%%% ENDINPUT thLine %%%%%\n\n\n"
"\n\n\n%%%%% INPUT thText %%%%%\n\n\n"
"%% therion source code\n"
"%%\n"
...
"  if strl>pathl:\n"
"    txtzoom := pathl / strl;\n"
"    message(\"[Warning: text scaled down to fit the path]\");\n"
"  else:\n"
"    txtzoom := 1;\n"
"  fi;\n"
"  zoom := pathl / strl;\n"
...
"enddef;\n"
"\n"
"def p_wall_altitude (expr pprev,pos,pnext,txt) =\n"
...
"%% therion source code\n"
"%%\n"
"%% This file defines macros for filling areas\n"
"%%\n"
"%% $Date: 2003/07/01 09:06:44 $\n"
"%% $RCSfile: thArea.mp,v $\n"
"%% $Revision: 1.3 $\n"
...
"let p_gypsum = p_gypsum_CCNP;\n"
"let p_aragonite = p_aragonite_CCNP;\n"
"let p_cavepearl = p_cavepearl_JSSJ;\n"
"let p_gypsumflower = p_gypsumflower_CCNP;\n"
...
"let p_raft = p_raft_CCNP;\n"
"let p_raftcone = p_raftcone_CCNP;\n"
"let p_spring = p_spring_SKBB;\n"
"let p_sink = p_sink_SKBB;\n"
"let p_narrowend = p_narrowend_UIS;\n"
"let p_lowend = p_lowend_UIS;\n"
"let p_flowstonechoke = p_flowstonechoke_CCNP;\n"
"let p_breakdownchoke = p_breakdownchoke_CCNP;\n"
"let p_bedrock = p_bedrock_ASF;\n"
"let p_clay = p_clay_UIS;                        \n"
...
"\n"
"let l_water_permanent = l_water_permanent_UIS;\n"
"let l_water_intermittent = l_water_intermittent_JSSJ;\n"
"let l_water_conjectural = l_water_conjectural_SKBB;\n"
"\n"
...
"let l_survey = l_survey_SKBB;\n"
"let l_arrow = l_arrow_SKBB;\n"
"\n"
"let PatternFill = thPatternFill;\n"
"\n"
"def a_water = scantokens(\"a_water_UIS\") enddef;\n"
"def a_sump = scantokens(\"a_sump_UIS\") enddef;\n"
"def a_sand = scantokens(\"a_sand_UIS\") enddef;\n"
"def a_debris = scantokens(\"a_debris_SKBB\") enddef;\n"
"\n"
"\n"
"\n"
"\n"
...
"%def Flowstonepattern = scantokens(\"a_water_UIS\") enddef;\n"
"%def Moonmilkpattern = scantokens(\"a_water_UIS\") enddef;\n"
"%def Icepattern = scantokens(\"a_water_UIS\") enddef;\n"
"\n"
"\n"
...
"initsymbol(\"p_raft_CCNP\");\n"
"initsymbol(\"p_raftcone_CCNP\");\n"
...
"initsymbol(\"p_sectionarrow_SKBB\");\n"
...
"initsymbol(\"l_slope_UIS\");\n"
"initsymbol(\"l_survey_JSSJ\");\n"
"initsymbol(\"l_survey_SKBB\");\n"
...
"initsymbol(\"l_water_conjectural_SKBB\");\n"
"initsymbol(\"l_water_intermittent_JSSJ\");\n"
"initsymbol(\"l_water_permanent_UIS\");\n"
