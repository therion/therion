...
"  if lang=\"fr\":\n"
"    if type=1: \"C\"        % rope\n"
"  \telseif type=2: \"Ef\"   % fixed ladder\n"
"  \telseif type=3: \"Ec\"   % rope ladder\n"
"  \telseif type=4: \"M\"    % steps\n"
"  \telseif type=5: \"P\"    % bridge\n"
"  \telseif type=6: \"T\"    % traverse\n"
"  \telseif type=7: \"A\"    % anchor\n"
"  \telseif type=8: \"B\"    % camp\n"
"  \telseif type=9: \"!\"    % not equipped\n"
"  \tfi\n"
"  elseif (lang=\"sk\") or (lang=\"cz\"):\n"
"    if type=1: \"L\"\n"
"  \telseif type=2: \"R\"\n"
"  \telseif type=3: \"Rl\"\n"
"  \telseif type=4: \"S\"\n"
...
"enddef;\n"
"\n"
"def l_rope_SKBB (expr P) =\n"
"  T:=identity;\n"
"  pickup PenX;\n"
"%  for i:=0 upto (length P):\n"
"%    thdraw point i of P withcolor red;\n"
"%  endfor;\n"
"  pickup PenC;\n"
"  d:=0.2cm;\n"
"  for i:=0 upto (length P - 1):\n"
...
"    fi;\n"
"%    thdraw (x3,y3) withcolor green withpen PenX;\n"
"    numeric a,b,c;\n"
"    a*x1*x1 + b*x1 + c = y1;\n"
"    a*x2*x2 + b*x2 + c = y2;\n"
"    a*x3*x3 + b*x3 + c = y3;\n"
...
"        draw origin shifted ((i,j) randomized 3mm) withpen PenC;\n"
"      endfor;  \n"
"    endfor;\n"
"  );\n"
"  clip tmp_pic to p;\n"
...
"  picture tmp_pic; \n"
"  tmp_pic := image(\n"
"    for i = xpart llcorner q step 8mm until xpart urcorner q:\n"
"      for j = ypart llcorner q step 8mm until ypart urcorner q:\n"
"        draw ((-.15u,0)--(.15u,0)) \n"
"             rotated uniformdeviate(360) \n"
"             shifted ((i,j) randomized 5mm) withpen PenC;\n"
"      endfor;  \n"
"    endfor;\n"
"  );\n"
"  clip tmp_pic to p;\n"
...
"enddef;\n"
"\n"
"def s_scalebar_STACHO (expr l, units, txt) = \n"
"  begingroup\n"
"    interim warningcheck:=0;\n"
"    tmpl:=l / Scale * cm * units / 2;\n"
"  endgroup;\n"
