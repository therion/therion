...
"  if turningnumber q = 0: message(\"[Warning: scrap outline intersects itself in \" & \n"
"          current_scrap & \"]\"); fi;\n"
"  if isout=1:\n"
...
"  thdrawoptions(dashed evenly scaled .5);\n"
...
"    if pnt=-1:\n"
"    else:\n"
"      T:=identity rotated angle(thdir(P,pnt)) shifted (point pnt of P);\n"
"      pickup PenC;\n"
"      thdraw (0,0)--(0,.8u);\n"
"      thdraw (-.1u,.55u)--(0,.8u)--(.1u,.55u);\n"
"    fi;\n"
...
"%    label.ulft(decimal l, origin);\n"
"%    label.urt(units, origin);\n"
