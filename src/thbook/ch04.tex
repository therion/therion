...
Therion currently doesn't provide any information about centerlines (such as 
length or depth of the cave). This should be implemented in the near future.
...
Therion exports centerline 3D models in Survex and Compass formats, which may 
