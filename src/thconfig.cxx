...
thconfig::thconfig()
{
  ...
  if (sp != NULL)
    ...
    if (sp != NULL) {
      this->search_path = sp;
#ifdef THWIN32
      this->search_path += "/.therion;C:/therion";
#else
      this->search_path += "/.therion:/usr/share/therion:/usr/local/share/therion";
#endif
    }
    else {
#ifdef THWIN32
      this->search_path += "C:/therion";
#else
      this->search_path += "/usr/share/therion:/usr/local/share/therion";
#endif
    }
  }
