...
// vystroj
    ...
    thpoint_type_export_mp(TT_POINT_TYPE_BONE,SYMP_BONE)
    ...
    thpoint_type_export_mp(TT_POINT_TYPE_DISCSPILLARS,SYMP_DISCSPILLARS)
    thpoint_type_export_mp(TT_POINT_TYPE_DISCSSTALACTITES,SYMP_DISCSSTALACTITES)
    thpoint_type_export_mp(TT_POINT_TYPE_DISCSSTALAGMITES,SYMP_DISCSSTALAGMITES)
    ...
    thpoint_type_export_mp(TT_POINT_TYPE_HUMANBONE,SYMP_HUMANBONE)
