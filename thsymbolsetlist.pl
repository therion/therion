...
$SYMHASH{p_flag_entrance} = "noassign";
$SYMHASH{p_flag_spring} = "noassign";
$SYMHASH{p_flag_sink} = "noassign";
$SYMHASH{p_flag_doline} = "noassign";
$SYMHASH{p_flag_airdraught} = "noassign";
$SYMHASH{p_flag_continuation} = "noassign";
$SYMHASH{p_flag_dig} = "noassign";
